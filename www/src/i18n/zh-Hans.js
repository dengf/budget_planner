...
export default {
  ...
  'cat.group.health': '健康',
  'cat.group.family': '家庭',
  'cat.group.personal': '个人',
  'cat.group.money': '理财',

  'cat.rentOrMortgage': '房租或房贷',
  'cat.utilities': '水电煤',
  'cat.utilitiesScc': '水电煤与杂费',
  'cat.internetPhone': '网络与电话',
  'cat.internetMobile': '网络与手机',
  'cat.groceries': '买菜采购',
  'cat.eatingOut': '外出就餐',
  'cat.hawkerEatingOut': '小贩中心与外食',
  'cat.carFuel': '汽车与油费',
  'cat.publicTransport': '公共交通',
  'cat.publicTransportGrab': '公共交通与打车',
  'cat.healthInsurance': '医疗保险',
  'cat.insurance': '保险',
  'cat.medicalPharmacy': '医疗与药品',
  'cat.medicalDental': '医疗与牙科',
  'cat.parentsAllowance': '孝亲费',
  'cat.subscriptions': '订阅服务',
  'cat.funLeisure': '休闲娱乐',
  'cat.savings': '储蓄',
  'cat.debtPayments': '还债',
