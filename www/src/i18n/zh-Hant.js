...
export default {
  ...
  'transactions.smartParseToggle': '智慧辨識（測試版）',
  'transactions.smartParseHint':
    '使用更大的 AI 模型更準確地辨識照片，仍完全在您的裝置上執行。首次使用會從 Hugging Face 下載約 {size}——建議在 Wi-Fi 下進行。之後會快取，只需下載一次。',
  ...
  'err.smartParseModelLoadFailed': '智慧辨識模型載入失敗（{value}）。請重試。',
  'err.smartParseTokenizerLoadFailed': '智慧辨識分詞器載入失敗（{value}）。',
  'err.smartParseFailed': '智慧辨識無法讀取該圖片（{value}）。請重試，或關閉智慧辨識。',
