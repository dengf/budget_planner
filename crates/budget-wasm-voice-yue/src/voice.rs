...
#[wasm_bindgen]
pub fn transcribe_voice_command_yue(model_bytes: &[u8], samples: &[f32]) -> JsValue {
    to_js(
        &match budget_calc::transcribe_voice_command_yue(model_bytes.to_vec(), samples) {
